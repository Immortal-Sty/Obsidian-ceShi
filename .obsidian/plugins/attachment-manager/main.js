...
var LocalizationAttachments = class {
  ...
  async processActivePage() {
    ...
    const folderPath = Path4.join(Path4.dirname(activeFile.path), buildFolderName(this.plugin.settings, activeFile.name));
    const imagePath = Path4.join(folderPath, buildPastedImageName(this.plugin.settings, activeFile.basename));
    if (activeFile.extension === "md") {
  ...
  async _process4MD(activeView, activeFile, imagePath) {
  ...
  async _process4Canvas(activeView, imagePath) {
