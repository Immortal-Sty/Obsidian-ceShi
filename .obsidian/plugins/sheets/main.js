  ...
  buildDomCell(rowIndex, columnIndex, rowNode) {
    ...
    if (cellContent == MERGE_LEFT_SIGNIFIER && ((_c = (_b = this.domGrid) == null ? void 0 : _b[rowIndex]) == null ? void 0 : _c[columnIndex - 1])) {
      ...
      import_obsidian2.MarkdownRenderer.render(
        ...
        var _a2;
        return cell.children[0].childNodes[0].textContent = ((_a2 = cell.children[0].childNodes[0].textContent) == null ? void 0 : _a2.replace(/^\\ /, "")) || "";
      });
